...
class _calculatorappState extends State<calculatorapp> {
  ...
  String previousNumber = '';//track the number before the arithmetic operation is clicked
  String currentNumber = ''; // track the number after the arithmetic operation is clicked
  String selectedOperation = '';//track the arithmetic operation
  ...
  void _calculateResult(){
    ...
    currentNumber = (_previousNumber % 1 == 0 ? _previousNumber.toInt() : _previousNumber)
        .toString();
    result = currentNumber;
  }
